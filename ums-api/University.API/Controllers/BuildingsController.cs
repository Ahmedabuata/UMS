...
public class BuildingsController : ControllerBase
{
    ...
    {
        var result = await _service.GetClassroomsAsync(id);
        return result.IsFailure ? ErrorResult(result) : Ok(result.Value);
    }

    [HttpPost]
    [HasPermission("BUILDING_WRITE")]
    public async Task<IActionResult> Create([FromBody] CreateBuildingRequestDto dto)
    {
    ...
    [HttpPut("{id:guid}")]
    [HasPermission("BUILDING_WRITE")]
    public async Task<IActionResult> Update(Guid id, [FromBody] CreateBuildingRequestDto dto)
    {
